...
public class JSONConverter {
    ...
    public static void main(String[] args) throws IOException, JSONException {
        ...
        BufferedReader br = new BufferedReader(new FileReader("/Users/xiaxun/Downloads/SentimentAnalysis-master/src"));
        String line = br.readLine();
        FileWriter fileWriter = new FileWriter("p/Users/xiaxun/Downloads/SentimentAnalysis-master/src.json");
